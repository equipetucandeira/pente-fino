...
<body class="w-full h-screen flex flex-col items-center justify-center bg-[url('/assets/images/bgImage-login.jpg')] bg-no-repeat bg-cover backdrop-blur-sm">
    ...
    <main class="w-11/12 md:w-10/12 lg:w-8/12 h-fit pb-10 flex flex-col justify-center md:justify-normal items-center bg-zinc-300 bg-opacity-90 rounded-2xl relative">

        <div class="w-[45px] md:w-[55px] lg:w-[60px] top-5 md:top-8 lg:top-10 left-5 md:left-8 lg:left-10 absolute hover:scale-110 ease-in-out duration-[400ms]">
            <a href="index.html">
        ...
        <form action="./login.php" method="post" class="w-fit h-fit flex flex-col items-center relative">
