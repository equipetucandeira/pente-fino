        ...
        <form action="./cadastro-send.php" method="POST" >
            ...
            <div class="step step-1 active">
                <div class="w-fit h-fit flex flex-col items-center">
                    ...
                    <input maxlenght="40" type="text" id="userLastName" name="userLastName" placeholder="Insira seu sobrenome"
                    ...
                    <input type="text" onfocus="(this.type = 'date')" id="userBirth" name="userBirth"
                        placeholder="Data de nascimento" class="w-[300px] md:w-[400px] lg:w-[450px] h-[50px] md:h-[55px] lg:h-[60px] 
            ...
            <div class="step step-2">
                ...
                <h1 Class="p-2 font-['Sancreek'] text-1xl text-black">Digite apenas números!</h1>
                    <input maxlenght="11" type="text" id="userPhone" name="userPhone" placeholder="Insira o telefone"
                        class="w-[300px] md:w-[400px] lg:w-[450px] h-[50px] md:h-[55px] lg:h-[60px] 
                                bg-[#262d3b] rounded-[15px] mt-5 pl-5 
                                text-white text-[15px] font-['Inter'] 
                                placeholder:text-[15px] required" required>
                    ...
                    <input maxlenght="11" type="text" id="userPhoneConfirm" name="userPhoneConfirm"
                        placeholder="Confirme o telefone" class="w-[300px] md:w-[400px] lg:w-[450px] h-[50px] md:h-[55px] lg:h-[60px] 
                                bg-[#262d3b] rounded-[15px] mt-5 pl-5 
                                text-white text-[15px] font-['Inter'] 
                                placeholder:text-[15px] required" required>
            ...
            <div class="step step-3">
                ...
                <h1 Class="p-6 font-['Sancreek'] text-3xl text-black">E-mail</h1>
                    ...
                    <input maxlenght="60" type="text" id="userEmailConfirm" name="userEmailConfirm"
                        placeholder="Confirme o E-mail" class="w-[300px] md:w-[400px] lg:w-[450px] h-[50px] md:h-[55px] lg:h-[60px] 
                                bg-[#262d3b] rounded-[15px] mt-5 pl-5 
                                text-white text-[15px] font-['Inter'] 
                                placeholder:text-[15px] required" required>
                    <span class="span-required">os campos devem ser iguais</span>
            ...
            <h1 Class="p-2 font-['Sancreek'] text-1xl text-black">Digite sua melhor senha!</h1>
                    ...
                    <input maxlenght="12" type="text" id="userPasswordConfirm" name="userPasswordConfirm"
                        placeholder="Confirme sua Senha" class="w-[300px] md:w-[400px] lg:w-[450px] h-[50px] md:h-[55px] lg:h-[60px] 
                                bg-[#262d3b] rounded-[15px] mt-5 pl-5 
                                text-white text-[15px] font-['Inter'] 
                                placeholder:text-[15px] required" required>
