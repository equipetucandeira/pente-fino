...
<body>
    ...
    <section class="border-4 border-black flex flex-col lg:flex-row m-4 lg:m-12 ">
        ...
        lg:pl-14 xl:pl-36 xl:items-start lg:p-0">
            ...
            <div id="sobre"
                class="text-center text-black text-[50px] md:text-[80px] lg:text-[60px]  font-normal font-['Smythe']">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="550"
                ...
                <defs>
                    <clipPath id="1285a9d0c1">
                        <path
                            d="M 99.171875 44.996094 L 450 44.996094 L 450 449.996094 L 99.171875 449.996094 Z M 99.171875 44.996094 "
                            clip-rule="nonzero" />
                    </clipPath>
                    ...
                    <clipPath id="4de32a4b74">
                        <path
                            d="M 449.992188 121.101562 L 243.035156 275.152344 L 147.648438 147.003906 L 354.605469 -7.046875 Z M 449.992188 121.101562 "
                            clip-rule="nonzero" />
                    </clipPath>
                    ...
                    <clipPath id="a11b84f6cf">
                        <path
                            d="M 396.527344 49.269531 L 308.941406 114.464844 L 266.539062 57.496094 L 354.121094 -7.699219 Z M 396.527344 49.269531 "
                            clip-rule="nonzero" />
                    </clipPath>
                    <clipPath id="b572bdf4ad">
                        <path
                            d="M 396.527344 49.269531 L 308.941406 114.464844 L 267.113281 58.265625 L 354.695312 -6.925781 Z M 396.527344 49.269531 "
                            clip-rule="nonzero" />
                    </clipPath>
                    ...
                    <clipPath id="269387c2a2">
                        <path
                            d="M 317.761719 155.570312 L 211.785156 234.453125 L 191.5625 207.285156 L 297.539062 128.402344 Z M 317.761719 155.570312 "
                            clip-rule="nonzero" />
                    </clipPath>
                    <clipPath id="cad8dee6d2">
                        <path
                            d="M 317.761719 155.570312 L 212.363281 234.023438 L 192.140625 206.855469 L 297.539062 128.402344 Z M 317.761719 155.570312 "
                            clip-rule="nonzero" />
                    </clipPath>
                ...
                <g clip-path="url(#1285a9d0c1)">
                    <path fill="#545454"
                        d="M 449.953125 449.996094 L 99.214844 247.496094 L 449.953125 44.996094 Z M 449.953125 449.996094 "
                            ...
                            <g clip-path="url(#1c0c7e80f9)">
                                <g clip-path="url(#269387c2a2)">
                                    <g clip-path="url(#cad8dee6d2)">
                                        <path fill="#000000"
                                            d="M 271.769531 147.996094 C 254.273438 172.0625 236.597656 195.996094 218.832031 219.863281 C 216.011719 223.644531 213.210938 227.4375 210.339844 231.300781 C 213.253906 231.726562 215.441406 231.238281 217.59375 229.003906 C 239.839844 205.933594 258.058594 187.257812 280.394531 164.285156 C 287.066406 157.417969 297.898438 146.28125 304.898438 139.074219 L 271.769531 147.996094 "
                                            fill-opacity="1" fill-rule="nonzero" />
                                    </g>
                                </g>
                            </g>
    ...
    <section class="flex flex-col justify-center items-center md:h-h-calc mt-10">
        ...
        <div class="w-percent-80 border border-solid border-black p-10 flex justify-around lg:flex-row flex-col">
            ...
            <div class="flex flex-col justify-center mt-10 items-center">
                ...
                <h2
                    class="font-['Smythe'] [text-shadow:_3px_3px_3px_rgb(236_167_44_/_70%)] md:text-7xl text-5xl mb-10 text-center font-bold">
    ...
    <!------------------------- O QUE FALAM DE NÓS -------------------------->
    <section
        class="w-[100%] h-fit lg:h-[100vh] flex flex-col mt-[100px] bg-[url('./assets/images/bgImage-quemsomos.png')] bg-cover bg-no-repeat">
        ...
        <section class="flex flex-col w-[100%] h-fit">
            ...
            <section
                class="flex flex-col items-center gap-[20px] pb-[50px] lg:flex-row md:justify-evenly w-[100%] h-fit mt-[6%]">
                ...
                bg-zinc-300 bg-opacity-90 rounded-[20px]">
                    ...
                    <p
                        class="flex flex-col self-center text-center text-[22px] w-[80%] mt-[20px] mb-[0] font-['Inter']">
                        “Sou cliente do Pente Fino a mais de 1 ano e recomendo demais!
                        Ambiente sempre limpo e super agradável. Nota 10!”
                        <br>
                        <span class="font-black lg:mt-[30px]">
