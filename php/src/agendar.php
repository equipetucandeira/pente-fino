    ...
    <section class="m-auto relative flex items-center justify-center min-h-screen">
        ...
        <form action="agendar-send.php" method="POST" class="w-full flex flex-col max-h-fit">
            ...
            <section class="w-[90%] self-center sm:flex justify-evenly">
                ...
                <section class="flex flex-col max-h-fit md:h-[280px] md:gap-[20px] md:mb-[20px]">

                    <label class="flex flex-col mb-10
                    text-black text-[20px] font-['Inter']">

                        <span class="font-bold">Serviço</span>
                        <select name="serviceUserSchedule" id="serviceUserSchedule" required class="border border-black rounded-md p-2 mt-5
                        rounded-[15px] text-black h-[50px] md:w-[250px]">

                            <option value="" selected disabled>Escolha um serviço</option>

                            <?php foreach ($results as $row) : ?>
                                <?php $category = $row['SERVICE_ID'] <= 3 ? 'CORTES' : 'BARBA' ?> <!---Quem sabe adicionar um campo no banco de dados que fale a categoria do serviço e apenas geramos o outgroup com base nela -->
                                <?php if (!isset($exist[$category])) : ?>
                                    <optgroup label="<?php echo $category; ?>">
                                        <?php $exist[$category] = true; ?>
                                    <?php endif; ?>
                    ...
                    text-black text-[20px] font-['Inter']">
                        ...
                        <select name="attendantUserSchedule" id="attendantUserSchedule" required class="border border-black rounded-md p-2 mt-5
                        rounded-[15px] text-black h-[50px] md:w-[250px]">
                ...
                <section class="flex flex-col max-h-fit md:h-[280px] md:gap-[20px] md:mb-[20px]">
                    ...
                    text-black text-[20px] font-['Inter']">
                        ...
                        <input type="date" id="dateUserSchedule" name="dateUserSchedule" required min="" maxlength="1" class="border border-black rounded-md p-2 mt-5 
                        rounded-[15px] text-black h-[50px] md:w-[250px]">
                    </label>
                    ...
                    text-black text-[20px] font-['Inter']">
                        ...
                        <select name="timeUserSchedule" id="timeUserSchedule" required class="border border-black rounded-md p-2 mt-5
                        rounded-[15px] text-black h-[50px] md:w-[250px]">
            ...
            md:flex-row md:gap-[10px] justify-evenly mt-5">
                ...
                text-[18px] text-white font-bold shadow-gray-500 shadow-md 
                hover:bg-[#684500] ease-in-out duration-[400ms]">
                    Confirmar Agendamento
                </button>

                <button type="reset" class="w-[240px] h-[80px] bg-[#b90101] rounded-md
                text-[18px] text-white font-bold shadow-gray-500 shadow-md 
